...
class TestRestaurant(unittest.TestCase):
    def test_valid_string(self):
        ...
        self.assertFalse(types.valid_string_for_restaurant('r3'))
    ...
    def test_from_string(self):
        ...
        self.assertRaises(KeyError, types.restaurant_from_string, 'r3')


class TestDishType(unittest.TestCase):
    def test_valid_string(self):
        valid_strs = ['menu1', 'menu2', 'vegetarian', 'speciality', 'grill',
                      'pasta', 'pizza']
...
class TestMenuItem(unittest.TestCase):
    def test_creation(self):
        mi = types.MenuItem(types.Restaurant.r1, date.today(),
                            types.DishType.menu1, 'Shit with sauce', 13.37)
